...
function monthCallsHTML() {
  ...
  const purposeHeader = hasPurpose ? '<th class="sortable" onclick="sortCallTable(\'purpose\',this)">Purpose <span class="sort-arrow">⇅</span></th>' : '';
  const rows = _callTableRows(md.calls, hasPurpose);
  return `<div class="table-card"><table>
    <thead><tr><th>Time (PT)</th><th class="sortable" onclick="sortCallTable('csm',this)">CSM <span class="sort-arrow">⇅</span></th><th>Account</th><th>Duration</th><th class="sortable" onclick="sortCallTable('health',this)">Signal <span class="sort-arrow">⇅</span></th>${purposeHeader}<th>Detail</th></tr></thead>
    <tbody>${rows}</tbody>
  </table>
