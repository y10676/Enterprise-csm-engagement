...
// Fri May 15: 6 Weflow + 8 SFDC enterprise events. Total W20: 33 Weflow calls
// + 11 SFDC events = 44 confirmed touchpoints. 7/8 CSMs active (Andy = 0).
// ═══════════════════════════════════════════════════════════════
...
function weekSummaryHTML_2026_W20() {
  ...
  <div class="summary-cards">
    <div class="sum-card c-teal" onclick="jumpToTab('wcalls','all','all')"><div class="sum-val">33</div><div class="sum-lbl">Weflow Calls</div><div class="sum-sub">Mon&ndash;Fri &middot; 13 accounts confirmed Fri</div></div>
    <div class="sum-card c-blue" onclick="jumpToTab('wcalls','all','all')"><div class="sum-val">44</div><div class="sum-lbl">Total Touchpoints</div><div class="sum-sub">Weflow calls + SFDC calendar events</div></div>
    <div class="sum-card c-green" onclick="jumpToTab('wpulses','all','all')"><div class="sum-val">42</div><div class="sum-lbl">Pulse Notes Created</div><div class="sum-sub">3 Healthy &middot; 6+ Concerning W20</div></div>
    ...
    <div class="sum-card c-amber" onclick="jumpToTab('wpulses','all','Concerning')"><div class="sum-val">6</div><div class="sum-lbl">Concerning Signals</div><div class="sum-sub">BILL &middot; Hitachi &middot; Korcomptenz &middot; +3</div></div>
  ...
  <div class="account-highlights">
    ...
    <div class="acct-card ac-amber"><div class="acct-name">Fri Concerning Block</div><div class="acct-csm">Zendesk &middot; Informatica &middot; Korcomptenz</div><div class="acct-stats"><div class="acct-stat"><div class="n ct">3</div><div class="l">SFDC</div></div><div class="acct-stat"><div class="n" style="color:#d97706">3</div><div class="l">Concerning</div></div><div class="acct-stat"><div class="n" style="color:#9ca3af">&#x2205;</div><div class="l">No Rec.</div></div></div><div class="acct-note">Three Concerning SFDC-only events on Friday: Varun &rarr; Zendesk (9 AM), Divyam &rarr; Informatica (10 AM), Nick &rarr; Korcomptenz (8:30 AM). No Weflow recordings captured. Renewal risk needs direct CSM follow-up next week.</div></div>
  ...
  <div class="health-dist">
    <div class="health-bar-wrap">
      <div class="health-bar-title">All Pulses Created This Week (42)</div>
      <div class="health-bar-row"><div class="health-bar-label">&#128994; Healthy</div><div class="health-bar-track"><div class="health-bar-fill hf-green" style="width:86%"></div></div><div class="health-bar-count">36</div></div>
      <div class="health-bar-row"><div class="health-bar-label">&#128993; Concerning</div><div class="health-bar-track"><div class="health-bar-fill hf-amber" style="width:14%"></div></div><div class="health-bar-count">6</div></div>
      <div class="health-bar-row"><div class="health-bar-label">&#128308; Poor</div><div class="health-bar-track"><div class="health-bar-fill hf-red" style="width:0%"></div></div><div class="health-bar-count">0</div></div>
    </div>
    <div class="health-bar-wrap">
      ...
      <div class="health-bar-row"><div class="health-bar-label">Fri May 15</div><div class="health-bar-track"><div class="health-bar-fill hf-amber" style="width:40%"></div></div><div class="health-bar-count">6+8&#x1F4C5;</div></div>
    </div>
  </div>`;
}
...
function weekCSMHTML_2026_W20() {
  ...
  <div class="csm-leaderboard">
    ...
    <div class="csm-row" data-csm="divyam"><div class="avatar av-divyam">DD</div><div style="flex:1"><div class="csm-row-name">Divyam Dewan <span style="font-size:11px;color:#d97706;font-weight:600">Action Needed</span></div><div class="csm-row-sub">BILL Operations (&#x26A0; departure + SF down) &middot; Safaricom &middot; Procore &middot; Lumen &middot; Adobe &middot; Xero &middot; Quadient SFDC &middot; Informatica SFDC</div></div><div class="csm-row-stats"><div class="row-stat"><div class="n ct">7</div><div class="l">Calls</div></div><div class="row-stat"><div class="n" style="color:#d97706">7</div><div class="l">Pulses</div></div><div class="row-stat"><div class="n" style="color:#d97706">2</div><div class="l">Concerning</div></div><div class="row-stat"><div class="n" style="color:#7c3aed">21</div><div class="l">Accounts</div></div><div class="row-stat"><div class="n" style="color:#2563eb">28</div><div class="l">Opps</div></div></div></div>
    <div class="csm-row" data-csm="atisha"><div class="avatar av-grey">AW</div><div style="flex:1"><div class="csm-row-name">Atisha Waghela</div><div class="csm-row-sub">RSM US (Fri &middot; FY27 plan) &middot; Salesforce (Wed &#x26A0;) &middot; Insight Direct &middot; Strada &middot; Apple &middot; Intel SFDC &middot; Apple x2 SFDC</div></div><div class="csm-row-stats"><div class="row-stat"><div class="n ct">6</div><div class="l">Calls</div></div><div class="row-stat"><div class="n" style="color:#d97706">6</div><div class="l">Pulses</div></div><div class="row-stat"><div class="n" style="color:#d97706">1</div><div class="l">Concerning</div></div><div class="row-stat"><div class="n" style="color:#7c3aed">18</div><div class="l">Accounts</div></div><div class="row-stat"><div class="n" style="color:#2563eb">22</div><div class="l">Opps</div></div></div></div>
    ...
    <div class="csm-row" data-csm="varun"><div class="avatar av-varun">VT</div><div style="flex:1"><div class="csm-row-name">Varun Tiwari</div><div class="csm-row-sub">Iron Mountain (x2) &middot; Five9 &middot; Capital One &middot; Zendesk SFDC (&#x26A0; Concerning)</div></div><div class="csm-row-stats"><div class="row-stat"><div class="n ct">4</div><div class="l">Calls</div></div><div class="row-stat"><div class="n" style="color:#d97706">4</div><div class="l">Pulses</div></div><div class="row-stat"><div class="n" style="color:#d97706">1</div><div class="l">Concerning</div></div><div class="row-stat"><div class="n" style="color:#7c3aed">21</div><div class="l">Accounts</div></div><div class="row-stat"><div class="n" style="color:#2563eb">26</div><div class="l">Opps</div></div></div></div>
...
function weekCallsHTML_2026_W20() {
  ...
  <div style="background:#1c1f26;border:1px solid #3b82f6;border-left:3px solid #3b82f6;border-radius:6px;padding:10px 14px;margin:10px 0;font-size:12px;color:#93c5fd;">
    &#x2139;&#xfe0f; <strong>Table shows Weflow-confirmed calls only.</strong> Friday also had 8 enterprise SFDC calendar events without Weflow recordings (see May 15 daily report for full list). &nbsp;|&nbsp; <strong>5 cross-coverage calls W20</strong>: Riley &rarr; Intuit IES (AW), IBM (NJ), Adobe TR (DD), ZScaler (VT) &middot; Nick &rarr; Intuit (AW).
  </div>
  <div class="empty-state" id="calls-empty" style="display:none"><div class="empty-icon">&#128269;</div>No calls match these filters.</div>`;
}
