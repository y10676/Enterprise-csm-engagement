...
// Fri May 15: 6 Weflow + 8 SFDC enterprise events. Total W20: 47 Weflow calls
// + 8 SFDC events = 55 confirmed touchpoints. 7/8 CSMs active (Andy = 0).
// ═══════════════════════════════════════════════════════════════
...
function weekSummaryHTML_2026_W20() {
  ...
  <div class="summary-cards">
    ...
    <div class="sum-card c-blue" onclick="jumpToTab('wcalls','all','all')"><div class="sum-val">55</div><div class="sum-lbl">Total Touchpoints</div><div class="sum-sub">47 Weflow calls + 8 SFDC events (Fri)</div></div>
